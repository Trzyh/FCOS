...
class ClsCntRegHead(nn.Module):
    def __init__(self,in_channel,class_num,GN=True,cnt_on_reg=True,prior=0.01):
        ...
        self.cls_logits=nn.Conv2d(in_channel,class_num,kernel_size=3,padding=1)  # 分类最后的卷积部分
        ...
        nn.init.constant_(self.cls_logits.bias,-math.log((1 - prior) / prior))  # 让刚开始的梯度不要过大
    ...
    def forward(self,inputs):
        ...
        for index,P in enumerate(inputs):
            ...
            reg_preds.append(torch.exp(self.reg_pred(reg_conv_out)))
